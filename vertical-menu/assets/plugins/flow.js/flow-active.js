        ...
        '<li class="flow-file list-group-item flow-file-'+file.uniqueIdentifier+'">' +
          '<div class="flow-progress media">' +
            ...
            '<div class="align-self-center ml-3">' +
              '<button type="button" class="flow-file-download btn btn-sm icon-btn btn-outline-primary waves-effect"><i class="mdi mdi-download"></i></button>' +
              '<button type="button" class="flow-file-pause btn btn-sm icon-btn btn-outline-warning waves-effect"><i class="mdi mdi-pause"></i></button> ' +
              '<button type="button" class="flow-file-resume btn btn-sm icon-btn btn-outline-success waves-effect"><i class="mdi mdi-play"></i></button> ' +
              '<button type="button" class="flow-file-cancel btn btn-sm icon-btn btn-outline-danger waves-effect"><i class="mdi mdi-close"></i></button>' +
            '</div>' +
          '</div>' +
        '</li>'
      );
